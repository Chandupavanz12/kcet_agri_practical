...
import { deleteNotification, getDeadlines, getNotifications, readNotification, savePushToken } from '../controllers/counseling.controller.js';
...
counselingRouter.delete('/notifications/:id', requireAuth, deleteNotification);
